...
namespace BibliotecaWebApplication.Migrations
{
    ...
    [Migration("20240822051722_initialSanti")]
    partial class initialSanti
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BibliotecaWebApplication.Models.Autor", b =>
                {
                    ...
                    b.Property<string>("SelectedAuthorIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BibliotecaWebApplication.Models.Libro", b =>
                {
                    ...
                    b.Property<Guid?>("PublicacionId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PublicacionId1")
                        .IsUnique()
                        .HasFilter("[PublicacionId1] IS NOT NULL");
            ...
            modelBuilder.Entity("BibliotecaWebApplication.Models.Libro", b =>
                {
                    ...
                    b.HasOne("BibliotecaWebApplication.Models.Publicacion", null)
                        .WithOne("Libro")
                        .HasForeignKey("BibliotecaWebApplication.Models.Libro", "PublicacionId1");
